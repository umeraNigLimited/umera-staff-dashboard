...
const REVENUE_CHANNEL_DATA = [
  ...
  { name: "Web Development", value: 29800 },
  { name: "Digital Marketing", value: 38200 },
  { name: "Social Media", value: 29800 },
];

const RevenueChannelChart = () => {
  return (
    <motion.div
    ...
    >
      ...
      <div className="h-80">
        <ResponsiveContainer>
          <BarChart data={REVENUE_CHANNEL_DATA}>
...
export default RevenueChannelChart;
